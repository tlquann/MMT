...
COMMANDS = {
    "LIST_APPLICATIONS": "operator", "OPEN_APPLICATION": "admin", "CLOSE_APPLICATION": "admin",
    "LIST_PROCESSES": "operator", "KILL_PROCESS": "admin", "LIST_FILES": "operator",
    "GET_TELEMETRY": "operator", "POWER_ACTION": "admin", "SCREEN_SNAPSHOT": "admin",
...
def validate_command(action: object, payload: object, role: str) -> str | None:
    ...
    if action in {"KILL_PROCESS", "CLOSE_APPLICATION"} and (not isinstance(payload.get("pid"), int) or payload["pid"] <= 0):
